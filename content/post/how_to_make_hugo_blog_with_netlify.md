...
### 🧐  이런 분한테는 hugo + netlify 조합이 별로일 것입니다.  
...
[hugo + netlify로 블로그 만드는 방법 참고한 youtube](https://www.youtube.com/watch?v=gSiAcyTWU3c)를 보면 hugo와 netlify를 이용해서 배포하는 과정을 이해하기 쉽습니다.      
[각 폴더의 역할 참고한 블로그](https://medium.com/@fgrgic/how-to-create-your-online-portfolio-the-fun-way-fb47ef0fb3c8)를 참고하면 블로그를 커스텀할 때 도움이 됩니다.      
